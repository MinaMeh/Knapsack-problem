...
def geneticAlgorithm(items, capacity,nb_tour, nb_solutions, nb_per_group, proba_mutation):
...
start = time.time()
listn,sol,gainT=geneticAlgorithm(items,cap,20,100,2,0.05)
#listn,sol,gainT=geneticAlgorithm(items,14,10,5,2,0.1)
